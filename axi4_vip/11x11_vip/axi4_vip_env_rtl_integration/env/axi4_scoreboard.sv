...
class axi4_scoreboard extends uvm_scoreboard;
    ...
    uvm_tlm_analysis_fifo #(axi4_master_tx) master_fifo[11];
    uvm_tlm_analysis_fifo #(axi4_slave_tx) slave_fifo[11];
    
    // Throughput tracking variables
    longint unsigned master_bytes_written[11];
    longint unsigned master_bytes_read[11];
    longint unsigned slave_bytes_written[11];
    longint unsigned slave_bytes_read[11];
    
    int unsigned master_write_count[11];
    int unsigned master_read_count[11];
    int unsigned slave_write_count[11];
    int unsigned slave_read_count[11];
