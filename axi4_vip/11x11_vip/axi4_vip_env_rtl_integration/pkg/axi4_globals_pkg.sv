...
package axi4_globals_pkg;
    ...
    parameter NO_OF_MASTERS    = 11;
    parameter NO_OF_SLAVES     = 11;
    parameter ADDRESS_WIDTH    = 64;
    parameter DATA_WIDTH       = 128;
    parameter ID_WIDTH         = 8;  // Max of master ID widths: [6, 6, 8, 4, 4, 4, 4, 8, 4, 4, 4]
    parameter STRB_WIDTH       = DATA_WIDTH/8;
    parameter USER_WIDTH       = 16;  // Max of master USER widths: [4, 4, 8, 0, 0, 0, 0, 16, 0, 0, 0]
    ...
    slave_config_t slave_configs[NO_OF_SLAVES] = '{
        ...
        '{"Slave2", 'h80000000000, 'h800000FFFFF, 32'd1048576}
    };
