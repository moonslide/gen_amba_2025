...
class axi4_virtual_stress_seq extends axi4_virtual_base_seq;
    ...
    // Body method
    virtual task body();
        axi4_master_random_seq random_seq[15];
        ...
        fork
            ...
            fork
                begin
                    ...
                    while (progress_count < num_trans) begin
                        #1us;
                        progress_count++;
                        if (progress_count % 10 == 0) begin
                            `uvm_info(get_type_name(), $sformatf("Progress: %0d/%0d transactions", progress_count, num_trans), UVM_LOW)
                        end
                    end
                end
            join_none
