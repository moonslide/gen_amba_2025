...
// Supports 15 masters and 15 slaves with full interconnect
//==============================================================================
...
module dut_wrapper #(
    ...
    // Instantiate the gen_amba_axi generated 15x15 AXI interconnect
    amba_axi_m15s15 #(
        ...
        .M11_AWID(master_if[11].awid),
        .M11_AWADDR(master_if[11].awaddr),
        .M11_AWLEN(master_if[11].awlen),
        .M11_AWSIZE(master_if[11].awsize),
        .M11_AWBURST(master_if[11].awburst),
        .M11_AWLOCK(master_if[11].awlock),
        .M11_AWCACHE(master_if[11].awcache),
        .M11_AWPROT(master_if[11].awprot),
        .M11_AWQOS(master_if[11].awqos),
        .M11_AWVALID(master_if[11].awvalid),
        .M11_AWREADY(master_if[11].awready),
        
        // Write data channel
        .M11_WDATA(master_if[11].wdata),
        .M11_WSTRB(master_if[11].wstrb),
        .M11_WLAST(master_if[11].wlast),
        .M11_WVALID(master_if[11].wvalid),
        .M11_WREADY(master_if[11].wready),
        
        // Write response channel
        .M11_BID(master_if[11].bid),
        .M11_BRESP(master_if[11].bresp),
        .M11_BVALID(master_if[11].bvalid),
        .M11_BREADY(master_if[11].bready),
        
        // Read address channel
        .M11_ARID(master_if[11].arid),
        .M11_ARADDR(master_if[11].araddr),
        .M11_ARLEN(master_if[11].arlen),
        .M11_ARSIZE(master_if[11].arsize),
        .M11_ARBURST(master_if[11].arburst),
        .M11_ARLOCK(master_if[11].arlock),
        .M11_ARCACHE(master_if[11].arcache),
        .M11_ARPROT(master_if[11].arprot),
        .M11_ARQOS(master_if[11].arqos),
        .M11_ARVALID(master_if[11].arvalid),
        .M11_ARREADY(master_if[11].arready),
        
        // Read data channel
        .M11_RID(master_if[11].rid),
        .M11_RDATA(master_if[11].rdata),
        .M11_RRESP(master_if[11].rresp),
        .M11_RLAST(master_if[11].rlast),
        .M11_RVALID(master_if[11].rvalid),
        .M11_RREADY(master_if[11].rready),
        // Master 12 connections
        .M12_AWID(master_if[12].awid),
        .M12_AWADDR(master_if[12].awaddr),
        .M12_AWLEN(master_if[12].awlen),
        .M12_AWSIZE(master_if[12].awsize),
        .M12_AWBURST(master_if[12].awburst),
        .M12_AWLOCK(master_if[12].awlock),
        .M12_AWCACHE(master_if[12].awcache),
        .M12_AWPROT(master_if[12].awprot),
        .M12_AWQOS(master_if[12].awqos),
        .M12_AWVALID(master_if[12].awvalid),
        .M12_AWREADY(master_if[12].awready),
        
        // Write data channel
        .M12_WDATA(master_if[12].wdata),
        .M12_WSTRB(master_if[12].wstrb),
        .M12_WLAST(master_if[12].wlast),
        .M12_WVALID(master_if[12].wvalid),
        .M12_WREADY(master_if[12].wready),
        
        // Write response channel
        .M12_BID(master_if[12].bid),
        .M12_BRESP(master_if[12].bresp),
        .M12_BVALID(master_if[12].bvalid),
        .M12_BREADY(master_if[12].bready),
        
        // Read address channel
        .M12_ARID(master_if[12].arid),
        .M12_ARADDR(master_if[12].araddr),
        .M12_ARLEN(master_if[12].arlen),
        .M12_ARSIZE(master_if[12].arsize),
        .M12_ARBURST(master_if[12].arburst),
        .M12_ARLOCK(master_if[12].arlock),
        .M12_ARCACHE(master_if[12].arcache),
        .M12_ARPROT(master_if[12].arprot),
        .M12_ARQOS(master_if[12].arqos),
        .M12_ARVALID(master_if[12].arvalid),
        .M12_ARREADY(master_if[12].arready),
        
        // Read data channel
        .M12_RID(master_if[12].rid),
        .M12_RDATA(master_if[12].rdata),
        .M12_RRESP(master_if[12].rresp),
        .M12_RLAST(master_if[12].rlast),
        .M12_RVALID(master_if[12].rvalid),
        .M12_RREADY(master_if[12].rready),
        // Master 13 connections
        .M13_AWID(master_if[13].awid),
        .M13_AWADDR(master_if[13].awaddr),
        .M13_AWLEN(master_if[13].awlen),
        .M13_AWSIZE(master_if[13].awsize),
        .M13_AWBURST(master_if[13].awburst),
        .M13_AWLOCK(master_if[13].awlock),
        .M13_AWCACHE(master_if[13].awcache),
        .M13_AWPROT(master_if[13].awprot),
        .M13_AWQOS(master_if[13].awqos),
        .M13_AWVALID(master_if[13].awvalid),
        .M13_AWREADY(master_if[13].awready),
        
        // Write data channel
        .M13_WDATA(master_if[13].wdata),
        .M13_WSTRB(master_if[13].wstrb),
        .M13_WLAST(master_if[13].wlast),
        .M13_WVALID(master_if[13].wvalid),
        .M13_WREADY(master_if[13].wready),
        
        // Write response channel
        .M13_BID(master_if[13].bid),
        .M13_BRESP(master_if[13].bresp),
        .M13_BVALID(master_if[13].bvalid),
        .M13_BREADY(master_if[13].bready),
        
        // Read address channel
        .M13_ARID(master_if[13].arid),
        .M13_ARADDR(master_if[13].araddr),
        .M13_ARLEN(master_if[13].arlen),
        .M13_ARSIZE(master_if[13].arsize),
        .M13_ARBURST(master_if[13].arburst),
        .M13_ARLOCK(master_if[13].arlock),
        .M13_ARCACHE(master_if[13].arcache),
        .M13_ARPROT(master_if[13].arprot),
        .M13_ARQOS(master_if[13].arqos),
        .M13_ARVALID(master_if[13].arvalid),
        .M13_ARREADY(master_if[13].arready),
        
        // Read data channel
        .M13_RID(master_if[13].rid),
        .M13_RDATA(master_if[13].rdata),
        .M13_RRESP(master_if[13].rresp),
        .M13_RLAST(master_if[13].rlast),
        .M13_RVALID(master_if[13].rvalid),
        .M13_RREADY(master_if[13].rready),
        // Master 14 connections
        .M14_AWID(master_if[14].awid),
        .M14_AWADDR(master_if[14].awaddr),
        .M14_AWLEN(master_if[14].awlen),
        .M14_AWSIZE(master_if[14].awsize),
        .M14_AWBURST(master_if[14].awburst),
        .M14_AWLOCK(master_if[14].awlock),
        .M14_AWCACHE(master_if[14].awcache),
        .M14_AWPROT(master_if[14].awprot),
        .M14_AWQOS(master_if[14].awqos),
        .M14_AWVALID(master_if[14].awvalid),
        .M14_AWREADY(master_if[14].awready),
        
        // Write data channel
        .M14_WDATA(master_if[14].wdata),
        .M14_WSTRB(master_if[14].wstrb),
        .M14_WLAST(master_if[14].wlast),
        .M14_WVALID(master_if[14].wvalid),
        .M14_WREADY(master_if[14].wready),
        
        // Write response channel
        .M14_BID(master_if[14].bid),
        .M14_BRESP(master_if[14].bresp),
        .M14_BVALID(master_if[14].bvalid),
        .M14_BREADY(master_if[14].bready),
        
        // Read address channel
        .M14_ARID(master_if[14].arid),
        .M14_ARADDR(master_if[14].araddr),
        .M14_ARLEN(master_if[14].arlen),
        .M14_ARSIZE(master_if[14].arsize),
        .M14_ARBURST(master_if[14].arburst),
        .M14_ARLOCK(master_if[14].arlock),
        .M14_ARCACHE(master_if[14].arcache),
        .M14_ARPROT(master_if[14].arprot),
        .M14_ARQOS(master_if[14].arqos),
        .M14_ARVALID(master_if[14].arvalid),
        .M14_ARREADY(master_if[14].arready),
        
        // Read data channel
        .M14_RID(master_if[14].rid),
        .M14_RDATA(master_if[14].rdata),
        .M14_RRESP(master_if[14].rresp),
        .M14_RLAST(master_if[14].rlast),
        .M14_RVALID(master_if[14].rvalid),
        .M14_RREADY(master_if[14].rready),
        ...
        .S11_AWID(slave_if[11].awid),
        .S11_AWADDR(slave_if[11].awaddr),
        .S11_AWLEN(slave_if[11].awlen),
        .S11_AWSIZE(slave_if[11].awsize),
        .S11_AWBURST(slave_if[11].awburst),
        .S11_AWLOCK(slave_if[11].awlock),
        .S11_AWCACHE(slave_if[11].awcache),
        .S11_AWPROT(slave_if[11].awprot),
        .S11_AWQOS(slave_if[11].awqos),
        .S11_AWVALID(slave_if[11].awvalid),
        .S11_AWREADY(slave_if[11].awready),
        
        // Write data channel
        .S11_WDATA(slave_if[11].wdata),
        .S11_WSTRB(slave_if[11].wstrb),
        .S11_WLAST(slave_if[11].wlast),
        .S11_WVALID(slave_if[11].wvalid),
        .S11_WREADY(slave_if[11].wready),
        
        // Write response channel
        .S11_BID(slave_if[11].bid),
        .S11_BRESP(slave_if[11].bresp),
        .S11_BVALID(slave_if[11].bvalid),
        .S11_BREADY(slave_if[11].bready),
        
        // Read address channel
        .S11_ARID(slave_if[11].arid),
        .S11_ARADDR(slave_if[11].araddr),
        .S11_ARLEN(slave_if[11].arlen),
        .S11_ARSIZE(slave_if[11].arsize),
        .S11_ARBURST(slave_if[11].arburst),
        .S11_ARLOCK(slave_if[11].arlock),
        .S11_ARCACHE(slave_if[11].arcache),
        .S11_ARPROT(slave_if[11].arprot),
        .S11_ARQOS(slave_if[11].arqos),
        .S11_ARVALID(slave_if[11].arvalid),
        .S11_ARREADY(slave_if[11].arready),
        
        // Read data channel
        .S11_RID(slave_if[11].rid),
        .S11_RDATA(slave_if[11].rdata),
        .S11_RRESP(slave_if[11].rresp),
        .S11_RLAST(slave_if[11].rlast),
        .S11_RVALID(slave_if[11].rvalid),
        .S11_RREADY(slave_if[11].rready),
        
        // Slave 12 connections
        .S12_AWID(slave_if[12].awid),
        .S12_AWADDR(slave_if[12].awaddr),
        .S12_AWLEN(slave_if[12].awlen),
        .S12_AWSIZE(slave_if[12].awsize),
        .S12_AWBURST(slave_if[12].awburst),
        .S12_AWLOCK(slave_if[12].awlock),
        .S12_AWCACHE(slave_if[12].awcache),
        .S12_AWPROT(slave_if[12].awprot),
        .S12_AWQOS(slave_if[12].awqos),
        .S12_AWVALID(slave_if[12].awvalid),
        .S12_AWREADY(slave_if[12].awready),
        
        // Write data channel
        .S12_WDATA(slave_if[12].wdata),
        .S12_WSTRB(slave_if[12].wstrb),
        .S12_WLAST(slave_if[12].wlast),
        .S12_WVALID(slave_if[12].wvalid),
        .S12_WREADY(slave_if[12].wready),
        
        // Write response channel
        .S12_BID(slave_if[12].bid),
        .S12_BRESP(slave_if[12].bresp),
        .S12_BVALID(slave_if[12].bvalid),
        .S12_BREADY(slave_if[12].bready),
        
        // Read address channel
        .S12_ARID(slave_if[12].arid),
        .S12_ARADDR(slave_if[12].araddr),
        .S12_ARLEN(slave_if[12].arlen),
        .S12_ARSIZE(slave_if[12].arsize),
        .S12_ARBURST(slave_if[12].arburst),
        .S12_ARLOCK(slave_if[12].arlock),
        .S12_ARCACHE(slave_if[12].arcache),
        .S12_ARPROT(slave_if[12].arprot),
        .S12_ARQOS(slave_if[12].arqos),
        .S12_ARVALID(slave_if[12].arvalid),
        .S12_ARREADY(slave_if[12].arready),
        
        // Read data channel
        .S12_RID(slave_if[12].rid),
        .S12_RDATA(slave_if[12].rdata),
        .S12_RRESP(slave_if[12].rresp),
        .S12_RLAST(slave_if[12].rlast),
        .S12_RVALID(slave_if[12].rvalid),
        .S12_RREADY(slave_if[12].rready),
        
        // Slave 13 connections
        .S13_AWID(slave_if[13].awid),
        .S13_AWADDR(slave_if[13].awaddr),
        .S13_AWLEN(slave_if[13].awlen),
        .S13_AWSIZE(slave_if[13].awsize),
        .S13_AWBURST(slave_if[13].awburst),
        .S13_AWLOCK(slave_if[13].awlock),
        .S13_AWCACHE(slave_if[13].awcache),
        .S13_AWPROT(slave_if[13].awprot),
        .S13_AWQOS(slave_if[13].awqos),
        .S13_AWVALID(slave_if[13].awvalid),
        .S13_AWREADY(slave_if[13].awready),
        
        // Write data channel
        .S13_WDATA(slave_if[13].wdata),
        .S13_WSTRB(slave_if[13].wstrb),
        .S13_WLAST(slave_if[13].wlast),
        .S13_WVALID(slave_if[13].wvalid),
        .S13_WREADY(slave_if[13].wready),
        
        // Write response channel
        .S13_BID(slave_if[13].bid),
        .S13_BRESP(slave_if[13].bresp),
        .S13_BVALID(slave_if[13].bvalid),
        .S13_BREADY(slave_if[13].bready),
        
        // Read address channel
        .S13_ARID(slave_if[13].arid),
        .S13_ARADDR(slave_if[13].araddr),
        .S13_ARLEN(slave_if[13].arlen),
        .S13_ARSIZE(slave_if[13].arsize),
        .S13_ARBURST(slave_if[13].arburst),
        .S13_ARLOCK(slave_if[13].arlock),
        .S13_ARCACHE(slave_if[13].arcache),
        .S13_ARPROT(slave_if[13].arprot),
        .S13_ARQOS(slave_if[13].arqos),
        .S13_ARVALID(slave_if[13].arvalid),
        .S13_ARREADY(slave_if[13].arready),
        
        // Read data channel
        .S13_RID(slave_if[13].rid),
        .S13_RDATA(slave_if[13].rdata),
        .S13_RRESP(slave_if[13].rresp),
        .S13_RLAST(slave_if[13].rlast),
        .S13_RVALID(slave_if[13].rvalid),
        .S13_RREADY(slave_if[13].rready),
        
        // Slave 14 connections
        .S14_AWID(slave_if[14].awid),
        .S14_AWADDR(slave_if[14].awaddr),
        .S14_AWLEN(slave_if[14].awlen),
        .S14_AWSIZE(slave_if[14].awsize),
        .S14_AWBURST(slave_if[14].awburst),
        .S14_AWLOCK(slave_if[14].awlock),
        .S14_AWCACHE(slave_if[14].awcache),
        .S14_AWPROT(slave_if[14].awprot),
        .S14_AWQOS(slave_if[14].awqos),
        .S14_AWVALID(slave_if[14].awvalid),
        .S14_AWREADY(slave_if[14].awready),
        
        // Write data channel
        .S14_WDATA(slave_if[14].wdata),
        .S14_WSTRB(slave_if[14].wstrb),
        .S14_WLAST(slave_if[14].wlast),
        .S14_WVALID(slave_if[14].wvalid),
        .S14_WREADY(slave_if[14].wready),
        
        // Write response channel
        .S14_BID(slave_if[14].bid),
        .S14_BRESP(slave_if[14].bresp),
        .S14_BVALID(slave_if[14].bvalid),
        .S14_BREADY(slave_if[14].bready),
        
        // Read address channel
        .S14_ARID(slave_if[14].arid),
        .S14_ARADDR(slave_if[14].araddr),
        .S14_ARLEN(slave_if[14].arlen),
        .S14_ARSIZE(slave_if[14].arsize),
        .S14_ARBURST(slave_if[14].arburst),
        .S14_ARLOCK(slave_if[14].arlock),
        .S14_ARCACHE(slave_if[14].arcache),
        .S14_ARPROT(slave_if[14].arprot),
        .S14_ARQOS(slave_if[14].arqos),
        .S14_ARVALID(slave_if[14].arvalid),
        .S14_ARREADY(slave_if[14].arready),
        
        // Read data channel
        .S14_RID(slave_if[14].rid),
        .S14_RDATA(slave_if[14].rdata),
        .S14_RRESP(slave_if[14].rresp),
        .S14_RLAST(slave_if[14].rlast),
        .S14_RVALID(slave_if[14].rvalid),
        .S14_RREADY(slave_if[14].rready)
    );
