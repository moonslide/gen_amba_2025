...
// - Added synchronization point after write data completion
// - Prevents infinite loop in write data channel handler
// - Ensures proper handshaking between data and response channels
//==============================================================================
            ...
            if(vif.wvalid && vif.wready) begin
                ...
                if(tr != null) begin
                    ...
                    if(vif.wlast) begin
                        ...
                        // Synchronization fix: Wait for response completion
                        // This prevents race conditions in write data processing
                        @(posedge vif.aclk);
                    end else begin
                        beat_cnt++;
                    end
