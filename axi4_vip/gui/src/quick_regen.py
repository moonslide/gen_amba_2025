#!/usr/bin/env python3
"""Quick RTL regeneration based on globals package"""
...
# Create configuration based on the globals package
config = BusConfig()
...
generator.output_dir = '/home/timtim01/eda_test/project/gen_amba_2025/test/axi4_vip_env_rtl_integration/rtl_wrapper/generated_rtl'
generator.generate_address_decoder()
generator.generate_arbiter()
generator.generate_interconnect()  # Also regenerate interconnect with new arbiter interface
