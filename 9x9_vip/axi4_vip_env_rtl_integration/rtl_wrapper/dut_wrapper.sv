...
// Supports 9 masters and 9 slaves with full interconnect
//==============================================================================
...
module dut_wrapper #(
    ...
    // Instantiate the full 9x9 AXI interconnect
    amba_axi_m9s9 #(
        ...
        .M0_AWREGION(master_if[0].awregion),
        ...
        .M0_ARREGION(master_if[0].arregion),
        ...
        .M1_AWCACHE(master_if[1].awcache), .M1_AWPROT(master_if[1].awprot), .M1_AWQOS(master_if[1].awqos), .M1_AWREGION(master_if[1].awregion),
        ...
        .M1_BID(master_if[1].bid), .M1_BRESP(master_if[1].bresp), .M1_BVALID(master_if[1].bvalid), .M1_BREADY(master_if[1].bready),
        .M1_ARID(master_if[1].arid), .M1_ARADDR(master_if[1].araddr), .M1_ARLEN(master_if[1].arlen),
        .M1_ARSIZE(master_if[1].arsize), .M1_ARBURST(master_if[1].arburst), .M1_ARLOCK(master_if[1].arlock),
        .M1_ARCACHE(master_if[1].arcache), .M1_ARPROT(master_if[1].arprot), .M1_ARQOS(master_if[1].arqos), .M1_ARREGION(master_if[1].arregion),
        .M1_ARVALID(master_if[1].arvalid), .M1_ARREADY(master_if[1].arready),
        ...
        .M2_AWCACHE(master_if[2].awcache), .M2_AWPROT(master_if[2].awprot), .M2_AWQOS(master_if[2].awqos), .M2_AWREGION(master_if[2].awregion),
        ...
        .M2_BID(master_if[2].bid), .M2_BRESP(master_if[2].bresp), .M2_BVALID(master_if[2].bvalid), .M2_BREADY(master_if[2].bready),
        .M2_ARID(master_if[2].arid), .M2_ARADDR(master_if[2].araddr), .M2_ARLEN(master_if[2].arlen),
        .M2_ARSIZE(master_if[2].arsize), .M2_ARBURST(master_if[2].arburst), .M2_ARLOCK(master_if[2].arlock),
        .M2_ARCACHE(master_if[2].arcache), .M2_ARPROT(master_if[2].arprot), .M2_ARQOS(master_if[2].arqos), .M2_ARREGION(master_if[2].arregion),
        .M2_ARVALID(master_if[2].arvalid), .M2_ARREADY(master_if[2].arready),
        ...
        .M3_AWCACHE(master_if[3].awcache), .M3_AWPROT(master_if[3].awprot), .M3_AWQOS(master_if[3].awqos), .M3_AWREGION(master_if[3].awregion),
        ...
        .M3_BID(master_if[3].bid), .M3_BRESP(master_if[3].bresp), .M3_BVALID(master_if[3].bvalid), .M3_BREADY(master_if[3].bready),
        .M3_ARID(master_if[3].arid), .M3_ARADDR(master_if[3].araddr), .M3_ARLEN(master_if[3].arlen),
        .M3_ARSIZE(master_if[3].arsize), .M3_ARBURST(master_if[3].arburst), .M3_ARLOCK(master_if[3].arlock),
        .M3_ARCACHE(master_if[3].arcache), .M3_ARPROT(master_if[3].arprot), .M3_ARQOS(master_if[3].arqos), .M3_ARREGION(master_if[3].arregion),
        .M3_ARVALID(master_if[3].arvalid), .M3_ARREADY(master_if[3].arready),
        ...
        .M4_AWCACHE(master_if[4].awcache), .M4_AWPROT(master_if[4].awprot), .M4_AWQOS(master_if[4].awqos), .M4_AWREGION(master_if[4].awregion),
        ...
        .M4_BID(master_if[4].bid), .M4_BRESP(master_if[4].bresp), .M4_BVALID(master_if[4].bvalid), .M4_BREADY(master_if[4].bready),
        .M4_ARID(master_if[4].arid), .M4_ARADDR(master_if[4].araddr), .M4_ARLEN(master_if[4].arlen),
        .M4_ARSIZE(master_if[4].arsize), .M4_ARBURST(master_if[4].arburst), .M4_ARLOCK(master_if[4].arlock),
        .M4_ARCACHE(master_if[4].arcache), .M4_ARPROT(master_if[4].arprot), .M4_ARQOS(master_if[4].arqos), .M4_ARREGION(master_if[4].arregion),
        .M4_ARVALID(master_if[4].arvalid), .M4_ARREADY(master_if[4].arready),
        ...
        .M5_AWCACHE(master_if[5].awcache), .M5_AWPROT(master_if[5].awprot), .M5_AWQOS(master_if[5].awqos), .M5_AWREGION(master_if[5].awregion),
        ...
        .M5_BID(master_if[5].bid), .M5_BRESP(master_if[5].bresp), .M5_BVALID(master_if[5].bvalid), .M5_BREADY(master_if[5].bready),
        .M5_ARID(master_if[5].arid), .M5_ARADDR(master_if[5].araddr), .M5_ARLEN(master_if[5].arlen),
        .M5_ARSIZE(master_if[5].arsize), .M5_ARBURST(master_if[5].arburst), .M5_ARLOCK(master_if[5].arlock),
        .M5_ARCACHE(master_if[5].arcache), .M5_ARPROT(master_if[5].arprot), .M5_ARQOS(master_if[5].arqos), .M5_ARREGION(master_if[5].arregion),
        .M5_ARVALID(master_if[5].arvalid), .M5_ARREADY(master_if[5].arready),
        ...
        .M6_AWCACHE(master_if[6].awcache), .M6_AWPROT(master_if[6].awprot), .M6_AWQOS(master_if[6].awqos), .M6_AWREGION(master_if[6].awregion),
        ...
        .M6_BID(master_if[6].bid), .M6_BRESP(master_if[6].bresp), .M6_BVALID(master_if[6].bvalid), .M6_BREADY(master_if[6].bready),
        .M6_ARID(master_if[6].arid), .M6_ARADDR(master_if[6].araddr), .M6_ARLEN(master_if[6].arlen),
        .M6_ARSIZE(master_if[6].arsize), .M6_ARBURST(master_if[6].arburst), .M6_ARLOCK(master_if[6].arlock),
        .M6_ARCACHE(master_if[6].arcache), .M6_ARPROT(master_if[6].arprot), .M6_ARQOS(master_if[6].arqos), .M6_ARREGION(master_if[6].arregion),
        .M6_ARVALID(master_if[6].arvalid), .M6_ARREADY(master_if[6].arready),
        ...
        .M7_AWCACHE(master_if[7].awcache), .M7_AWPROT(master_if[7].awprot), .M7_AWQOS(master_if[7].awqos), .M7_AWREGION(master_if[7].awregion),
        ...
        .M7_BID(master_if[7].bid), .M7_BRESP(master_if[7].bresp), .M7_BVALID(master_if[7].bvalid), .M7_BREADY(master_if[7].bready),
        .M7_ARID(master_if[7].arid), .M7_ARADDR(master_if[7].araddr), .M7_ARLEN(master_if[7].arlen),
        .M7_ARSIZE(master_if[7].arsize), .M7_ARBURST(master_if[7].arburst), .M7_ARLOCK(master_if[7].arlock),
        .M7_ARCACHE(master_if[7].arcache), .M7_ARPROT(master_if[7].arprot), .M7_ARQOS(master_if[7].arqos), .M7_ARREGION(master_if[7].arregion),
        .M7_ARVALID(master_if[7].arvalid), .M7_ARREADY(master_if[7].arready),
        ...
        .M8_AWCACHE(master_if[8].awcache), .M8_AWPROT(master_if[8].awprot), .M8_AWQOS(master_if[8].awqos), .M8_AWREGION(master_if[8].awregion),
        ...
        .M8_BID(master_if[8].bid), .M8_BRESP(master_if[8].bresp), .M8_BVALID(master_if[8].bvalid), .M8_BREADY(master_if[8].bready),
        .M8_ARID(master_if[8].arid), .M8_ARADDR(master_if[8].araddr), .M8_ARLEN(master_if[8].arlen),
        .M8_ARSIZE(master_if[8].arsize), .M8_ARBURST(master_if[8].arburst), .M8_ARLOCK(master_if[8].arlock),
        .M8_ARCACHE(master_if[8].arcache), .M8_ARPROT(master_if[8].arprot), .M8_ARQOS(master_if[8].arqos), .M8_ARREGION(master_if[8].arregion),
        .M8_ARVALID(master_if[8].arvalid), .M8_ARREADY(master_if[8].arready),
        ...
        .S0_AWCACHE(slave_if[0].awcache), .S0_AWPROT(slave_if[0].awprot), .S0_AWQOS(slave_if[0].awqos), .S0_AWREGION(slave_if[0].awregion),
        ...
        .S0_BID(slave_if[0].bid), .S0_BRESP(slave_if[0].bresp), .S0_BVALID(slave_if[0].bvalid), .S0_BREADY(slave_if[0].bready),
        .S0_ARID(slave_if[0].arid), .S0_ARADDR(slave_if[0].araddr), .S0_ARLEN(slave_if[0].arlen),
        .S0_ARSIZE(slave_if[0].arsize), .S0_ARBURST(slave_if[0].arburst), .S0_ARLOCK(slave_if[0].arlock),
        .S0_ARCACHE(slave_if[0].arcache), .S0_ARPROT(slave_if[0].arprot), .S0_ARQOS(slave_if[0].arqos), .S0_ARREGION(slave_if[0].arregion),
        .S0_ARVALID(slave_if[0].arvalid), .S0_ARREADY(slave_if[0].arready),
        ...
        .S1_AWCACHE(slave_if[1].awcache), .S1_AWPROT(slave_if[1].awprot), .S1_AWQOS(slave_if[1].awqos), .S1_AWREGION(slave_if[1].awregion),
        ...
        .S1_BID(slave_if[1].bid), .S1_BRESP(slave_if[1].bresp), .S1_BVALID(slave_if[1].bvalid), .S1_BREADY(slave_if[1].bready),
        .S1_ARID(slave_if[1].arid), .S1_ARADDR(slave_if[1].araddr), .S1_ARLEN(slave_if[1].arlen),
        .S1_ARSIZE(slave_if[1].arsize), .S1_ARBURST(slave_if[1].arburst), .S1_ARLOCK(slave_if[1].arlock),
        .S1_ARCACHE(slave_if[1].arcache), .S1_ARPROT(slave_if[1].arprot), .S1_ARQOS(slave_if[1].arqos), .S1_ARREGION(slave_if[1].arregion),
        .S1_ARVALID(slave_if[1].arvalid), .S1_ARREADY(slave_if[1].arready),
        ...
        .S2_AWCACHE(slave_if[2].awcache), .S2_AWPROT(slave_if[2].awprot), .S2_AWQOS(slave_if[2].awqos), .S2_AWREGION(slave_if[2].awregion),
        ...
        .S2_BID(slave_if[2].bid), .S2_BRESP(slave_if[2].bresp), .S2_BVALID(slave_if[2].bvalid), .S2_BREADY(slave_if[2].bready),
        .S2_ARID(slave_if[2].arid), .S2_ARADDR(slave_if[2].araddr), .S2_ARLEN(slave_if[2].arlen),
        .S2_ARSIZE(slave_if[2].arsize), .S2_ARBURST(slave_if[2].arburst), .S2_ARLOCK(slave_if[2].arlock),
        .S2_ARCACHE(slave_if[2].arcache), .S2_ARPROT(slave_if[2].arprot), .S2_ARQOS(slave_if[2].arqos), .S2_ARREGION(slave_if[2].arregion),
        .S2_ARVALID(slave_if[2].arvalid), .S2_ARREADY(slave_if[2].arready),
        ...
        .S3_AWCACHE(slave_if[3].awcache), .S3_AWPROT(slave_if[3].awprot), .S3_AWQOS(slave_if[3].awqos), .S3_AWREGION(slave_if[3].awregion),
        ...
        .S3_BID(slave_if[3].bid), .S3_BRESP(slave_if[3].bresp), .S3_BVALID(slave_if[3].bvalid), .S3_BREADY(slave_if[3].bready),
        .S3_ARID(slave_if[3].arid), .S3_ARADDR(slave_if[3].araddr), .S3_ARLEN(slave_if[3].arlen),
        .S3_ARSIZE(slave_if[3].arsize), .S3_ARBURST(slave_if[3].arburst), .S3_ARLOCK(slave_if[3].arlock),
        .S3_ARCACHE(slave_if[3].arcache), .S3_ARPROT(slave_if[3].arprot), .S3_ARQOS(slave_if[3].arqos), .S3_ARREGION(slave_if[3].arregion),
        .S3_ARVALID(slave_if[3].arvalid), .S3_ARREADY(slave_if[3].arready),
        ...
        .S4_AWCACHE(slave_if[4].awcache), .S4_AWPROT(slave_if[4].awprot), .S4_AWQOS(slave_if[4].awqos), .S4_AWREGION(slave_if[4].awregion),
        ...
        .S4_BID(slave_if[4].bid), .S4_BRESP(slave_if[4].bresp), .S4_BVALID(slave_if[4].bvalid), .S4_BREADY(slave_if[4].bready),
        .S4_ARID(slave_if[4].arid), .S4_ARADDR(slave_if[4].araddr), .S4_ARLEN(slave_if[4].arlen),
        .S4_ARSIZE(slave_if[4].arsize), .S4_ARBURST(slave_if[4].arburst), .S4_ARLOCK(slave_if[4].arlock),
        .S4_ARCACHE(slave_if[4].arcache), .S4_ARPROT(slave_if[4].arprot), .S4_ARQOS(slave_if[4].arqos), .S4_ARREGION(slave_if[4].arregion),
        .S4_ARVALID(slave_if[4].arvalid), .S4_ARREADY(slave_if[4].arready),
        ...
        .S5_AWCACHE(slave_if[5].awcache), .S5_AWPROT(slave_if[5].awprot), .S5_AWQOS(slave_if[5].awqos), .S5_AWREGION(slave_if[5].awregion),
        ...
        .S5_BID(slave_if[5].bid), .S5_BRESP(slave_if[5].bresp), .S5_BVALID(slave_if[5].bvalid), .S5_BREADY(slave_if[5].bready),
        .S5_ARID(slave_if[5].arid), .S5_ARADDR(slave_if[5].araddr), .S5_ARLEN(slave_if[5].arlen),
        .S5_ARSIZE(slave_if[5].arsize), .S5_ARBURST(slave_if[5].arburst), .S5_ARLOCK(slave_if[5].arlock),
        .S5_ARCACHE(slave_if[5].arcache), .S5_ARPROT(slave_if[5].arprot), .S5_ARQOS(slave_if[5].arqos), .S5_ARREGION(slave_if[5].arregion),
        .S5_ARVALID(slave_if[5].arvalid), .S5_ARREADY(slave_if[5].arready),
        ...
        .S6_AWCACHE(slave_if[6].awcache), .S6_AWPROT(slave_if[6].awprot), .S6_AWQOS(slave_if[6].awqos), .S6_AWREGION(slave_if[6].awregion),
        ...
        .S6_BID(slave_if[6].bid), .S6_BRESP(slave_if[6].bresp), .S6_BVALID(slave_if[6].bvalid), .S6_BREADY(slave_if[6].bready),
        .S6_ARID(slave_if[6].arid), .S6_ARADDR(slave_if[6].araddr), .S6_ARLEN(slave_if[6].arlen),
        .S6_ARSIZE(slave_if[6].arsize), .S6_ARBURST(slave_if[6].arburst), .S6_ARLOCK(slave_if[6].arlock),
        .S6_ARCACHE(slave_if[6].arcache), .S6_ARPROT(slave_if[6].arprot), .S6_ARQOS(slave_if[6].arqos), .S6_ARREGION(slave_if[6].arregion),
        .S6_ARVALID(slave_if[6].arvalid), .S6_ARREADY(slave_if[6].arready),
        ...
        .S7_AWCACHE(slave_if[7].awcache), .S7_AWPROT(slave_if[7].awprot), .S7_AWQOS(slave_if[7].awqos), .S7_AWREGION(slave_if[7].awregion),
        ...
        .S7_BID(slave_if[7].bid), .S7_BRESP(slave_if[7].bresp), .S7_BVALID(slave_if[7].bvalid), .S7_BREADY(slave_if[7].bready),
        .S7_ARID(slave_if[7].arid), .S7_ARADDR(slave_if[7].araddr), .S7_ARLEN(slave_if[7].arlen),
        .S7_ARSIZE(slave_if[7].arsize), .S7_ARBURST(slave_if[7].arburst), .S7_ARLOCK(slave_if[7].arlock),
        .S7_ARCACHE(slave_if[7].arcache), .S7_ARPROT(slave_if[7].arprot), .S7_ARQOS(slave_if[7].arqos), .S7_ARREGION(slave_if[7].arregion),
        .S7_ARVALID(slave_if[7].arvalid), .S7_ARREADY(slave_if[7].arready),
        ...
        .S8_AWCACHE(slave_if[8].awcache), .S8_AWPROT(slave_if[8].awprot), .S8_AWQOS(slave_if[8].awqos), .S8_AWREGION(slave_if[8].awregion),
        ...
        .S8_BID(slave_if[8].bid), .S8_BRESP(slave_if[8].bresp), .S8_BVALID(slave_if[8].bvalid), .S8_BREADY(slave_if[8].bready),
        .S8_ARID(slave_if[8].arid), .S8_ARADDR(slave_if[8].araddr), .S8_ARLEN(slave_if[8].arlen),
        .S8_ARSIZE(slave_if[8].arsize), .S8_ARBURST(slave_if[8].arburst), .S8_ARLOCK(slave_if[8].arlock),
        .S8_ARCACHE(slave_if[8].arcache), .S8_ARPROT(slave_if[8].arprot), .S8_ARQOS(slave_if[8].arqos), .S8_ARREGION(slave_if[8].arregion),
        .S8_ARVALID(slave_if[8].arvalid), .S8_ARREADY(slave_if[8].arready),
