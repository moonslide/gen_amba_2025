...
module dut_wrapper #(
    ...
    // Slave 0 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s0_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s0_bid;   // 8-bit slave ID
    logic [1:0]              s0_bresp;
    logic                    s0_bvalid;
    logic                    s0_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s0_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s0_rid;   // 8-bit slave ID
    ...
    // Slave 1 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s1_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s1_bid;  // 8-bit slave ID
    logic [1:0]              s1_bresp;
    logic                    s1_bvalid;
    logic                    s1_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s1_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s1_rid;  // 8-bit slave ID
    ...
    // Slave 2 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s2_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s2_bid;  // 8-bit slave ID
    logic [1:0]              s2_bresp;
    logic                    s2_bvalid;
    logic                    s2_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s2_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s2_rid;  // 8-bit slave ID
    ...
    // Slave 3 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s3_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s3_bid;  // 8-bit slave ID
    logic [1:0]              s3_bresp;
    logic                    s3_bvalid;
    logic                    s3_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s3_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s3_rid;  // 8-bit slave ID
    ...
    // Slave 4 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s4_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s4_bid;  // 8-bit slave ID
    logic [1:0]              s4_bresp;
    logic                    s4_bvalid;
    logic                    s4_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s4_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s4_rid;  // 8-bit slave ID
    ...
    // Slave 5 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s5_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s5_bid;  // 8-bit slave ID
    logic [1:0]              s5_bresp;
    logic                    s5_bvalid;
    logic                    s5_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s5_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s5_rid;  // 8-bit slave ID
    ...
    // Slave 6 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s6_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s6_bid;  // 8-bit slave ID
    logic [1:0]              s6_bresp;
    logic                    s6_bvalid;
    logic                    s6_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s6_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s6_rid;  // 8-bit slave ID
    ...
    // Slave 7 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s7_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s7_bid;  // 8-bit slave ID
    logic [1:0]              s7_bresp;
    logic                    s7_bvalid;
    logic                    s7_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s7_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s7_rid;  // 8-bit slave ID
    ...
    // Slave 8 signals
    logic [ID_WIDTH+$clog2(9)-1:0] s8_awid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s8_bid;  // 8-bit slave ID
    logic [1:0]              s8_bresp;
    logic                    s8_bvalid;
    logic                    s8_bready;
    
    logic [ID_WIDTH+$clog2(9)-1:0] s8_arid;  // 8-bit slave ID
    ...
    logic [ID_WIDTH+$clog2(9)-1:0] s8_rid;  // 8-bit slave ID
