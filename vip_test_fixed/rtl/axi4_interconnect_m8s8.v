...
axi4_arbiter #(
    ...
    .master_request({m7_slave_select[0], m6_slave_select[0], m5_slave_select[0], m4_slave_select[0], m3_slave_select[0], m2_slave_select[0], m1_slave_select[0], m0_slave_select[0]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
axi4_arbiter #(
    ...
    // Scalable vectorized interface per AXI4 spec
    .master_request({m7_slave_select[1], m6_slave_select[1], m5_slave_select[1], m4_slave_select[1], m3_slave_select[1], m2_slave_select[1], m1_slave_select[1], m0_slave_select[1]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
axi4_arbiter #(
    ...
    // Scalable vectorized interface per AXI4 spec
    .master_request({m7_slave_select[2], m6_slave_select[2], m5_slave_select[2], m4_slave_select[2], m3_slave_select[2], m2_slave_select[2], m1_slave_select[2], m0_slave_select[2]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
axi4_arbiter #(
    ...
    // Scalable vectorized interface per AXI4 spec
    .master_request({m7_slave_select[3], m6_slave_select[3], m5_slave_select[3], m4_slave_select[3], m3_slave_select[3], m2_slave_select[3], m1_slave_select[3], m0_slave_select[3]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
axi4_arbiter #(
    ...
    // Scalable vectorized interface per AXI4 spec
    .master_request({m7_slave_select[4], m6_slave_select[4], m5_slave_select[4], m4_slave_select[4], m3_slave_select[4], m2_slave_select[4], m1_slave_select[4], m0_slave_select[4]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
axi4_arbiter #(
    ...
    // Scalable vectorized interface per AXI4 spec
    .master_request({m7_slave_select[5], m6_slave_select[5], m5_slave_select[5], m4_slave_select[5], m3_slave_select[5], m2_slave_select[5], m1_slave_select[5], m0_slave_select[5]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
axi4_arbiter #(
    ...
    // Scalable vectorized interface per AXI4 spec
    .master_request({m7_slave_select[6], m6_slave_select[6], m5_slave_select[6], m4_slave_select[6], m3_slave_select[6], m2_slave_select[6], m1_slave_select[6], m0_slave_select[6]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
axi4_arbiter #(
    ...
    // Scalable vectorized interface per AXI4 spec
    .master_request({m7_slave_select[7], m6_slave_select[7], m5_slave_select[7], m4_slave_select[7], m3_slave_select[7], m2_slave_select[7], m1_slave_select[7], m0_slave_select[7]}),
    .master_valid({(m7_awvalid || m7_arvalid), (m6_awvalid || m6_arvalid), (m5_awvalid || m5_arvalid), (m4_awvalid || m4_arvalid), (m3_awvalid || m3_arvalid), (m2_awvalid || m2_arvalid), (m1_awvalid || m1_arvalid), (m0_awvalid || m0_arvalid)}),
    .master_qos({m7_awqos, m6_awqos, m5_awqos, m4_awqos, m3_awqos, m2_awqos, m1_awqos, m0_awqos}),
    .master_id({m7_awid, m6_awid, m5_awid, m4_awid, m3_awid, m2_awid, m1_awid, m0_awid}),
...
// Slave 2 - slave2
// Address range: 0x20000000 - 0x2FFFFFFF
// Regions: 1

// Slave 3 - slave3
// Address range: 0x30000000 - 0x3FFFFFFF
// Regions: 1

// Slave 4 - slave4
// Address range: 0x40000000 - 0x4FFFFFFF
// Regions: 1

// Slave 5 - slave5
// Address range: 0x50000000 - 0x5FFFFFFF
// Regions: 1
...
// Slave 7 - slave7
// Address range: 0x70000000 - 0x7FFFFFFF
// Regions: 1
