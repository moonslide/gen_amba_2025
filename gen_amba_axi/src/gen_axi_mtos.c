...
fprintf(fo, "                 , WIDTH_AWUSER =WIDTH_AWUSER // Write-address user path\n");
fprintf(fo, "                 `endif\n");
fprintf(fo, "                 `ifdef AMBA_AXI_WUSER\n");
fprintf(fo, "                 , WIDTH_WUSER  =WIDTH_WUSER // Write-data user path\n");
fprintf(fo, "                 `endif\n");
fprintf(fo, "                 `ifdef AMBA_AXI_ARUSER\n");
fprintf(fo, "                 , WIDTH_ARUSER =WIDTH_ARUSER // read-address user path\n");
fprintf(fo, "                 `endif\n");
