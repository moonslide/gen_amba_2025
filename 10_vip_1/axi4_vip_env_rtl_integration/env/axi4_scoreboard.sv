...
class axi4_scoreboard extends uvm_scoreboard;
    ...
    uvm_tlm_analysis_fifo #(axi4_master_tx) master_fifo[10];
    uvm_tlm_analysis_fifo #(axi4_slave_tx) slave_fifo[10];
    
    // Throughput tracking variables
    longint unsigned master_bytes_written[10];
    longint unsigned master_bytes_read[10];
    longint unsigned slave_bytes_written[10];
    longint unsigned slave_bytes_read[10];
    
    int unsigned master_write_count[10];
    int unsigned master_read_count[10];
    int unsigned slave_write_count[10];
    int unsigned slave_read_count[10];
