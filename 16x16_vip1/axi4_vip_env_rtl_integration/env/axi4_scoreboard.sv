...
//==============================================================================
    ...
    class axi4_scoreboard extends uvm_scoreboard;
        ...
        uvm_tlm_analysis_fifo #(axi4_master_tx) master_fifo[16];  // 16x16 matrix support
        ...
        function void build_phase(uvm_phase phase);
            ...
            // Create fifo arrays for 16x16 matrix support
            ...
            `uvm_info(get_type_name(), "Scoreboard built with WLAST tracking and 16x16 fifo arrays", UVM_LOW)
        endfunction
        
        virtual task run_phase(uvm_phase phase);
            `uvm_info(get_type_name(), "Starting scoreboard with WLAST monitoring and 16x16 fifo processing", UVM_LOW)
