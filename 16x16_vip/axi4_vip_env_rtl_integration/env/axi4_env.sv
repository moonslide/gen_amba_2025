...
class axi4_env extends uvm_env;
    ...
    function void build_phase(uvm_phase phase);
        ...
        `uvm_info(get_type_name(), "Building AXI4 environment components", UVM_LOW)
        `uvm_info(get_type_name(), $sformatf("Creating %0d masters and %0d slaves", 16, 16), UVM_MEDIUM)
    ...
    function void connect_phase(uvm_phase phase);
        ...
        `uvm_info(get_type_name(), "Connecting environment components", UVM_LOW)
