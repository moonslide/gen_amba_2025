...
class SlaveDialog:
    ...
    def update_address_info(self):
        ...
        try:
            ...
            if self.main_gui and hasattr(self.main_gui, 'current_config'):
                ...
                if conflicts:
                    ...
                    if suggested_addr is not None:
                        info_text += f"\n💡 Suggested Address: 0x{suggested_addr:08X}"
            ...
            self.info_label.config(text="❌ Invalid address/size format", foreground="red")
        except Exception as e:
    ...
    def show_address_map(self, conflicts):
        ...
        for i, entry in enumerate(map_entries):
            ...
            label = ttk.Label(self.address_map_frame, text=f"{'⚠️' if color == 'red' else '📍'} {addr_text}",
