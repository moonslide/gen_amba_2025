...
- WARNING: Masters have different ID widths: CPU_Cluster_0=6, CPU_Cluster_1=6, GPU=8, Video_Encoder=4, Video_Decoder=4, DMA_Engine_0=4, DMA_Engine_1=4, PCIe_Controller=8, Master0=4
-          Using maximum ID width (8) for interconnect
- WARNING: Masters have different USER widths: CPU_Cluster_0=4, CPU_Cluster_1=4, GPU=8, Video_Encoder=0, Video_Decoder=0, DMA_Engine_0=0, DMA_Engine_1=0, PCIe_Controller=16, Master0=0
